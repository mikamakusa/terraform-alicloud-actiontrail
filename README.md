...
| Name | Type |
|------|------|
| [alicloud_actiontrail.this](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/actiontrail) | resource |
...
| [alicloud_mns_topic.this](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/mns_topic) | resource |
...
| <a name="input_trail"></a> [trail](#input\_trail) | n/a | <pre>list(object({<br>    id                    = number<br>    trail_id              = optional(string)<br>    name                  = optional(string)<br>    event_rw              = optional(string)<br>    oss_bucket_id         = optional(number)<br>    oss_key_prefix        = optional(string)<br>    role_name             = optional(number)<br>    sls_project_id        = optional(number)<br>    sls_write_role_arn    = optional(string)<br>    mns_topic_id          = optional(number)<br>    status                = optional(string)<br>    is_organization_trail = optional(bool, false)<br>  }))</pre> | `[]` | no |
